...
public class CFCallNumber extends CordovaPlugin {
  ...
  private void callPhone(JSONArray args) throws JSONException {
  		...
  		System.out.println("Running USSD Code");
    	// String code = "533*5555*0009781760*044*0002643239*058*50000*1234";
    ...
    try{
        ...
        //ctx.startActivity(new Intent("android.intent.action.CALL", Uri.parse("tel:" + ussdCode)));
		 this.cordova.startActivityForResult((CordovaPlugin) this,new Intent("android.intent.action.CALL", Uri.parse("tel:" + ussdCode)),0);
		 
		   callbackContext.success();
    }catch (Exception e){
    	System.out.println("Error while calling number "+e);
